...
#village
    def village_room(self):
        ...
        choice = input("You just passed your family without communicate. Your holiday has ended and you need to go back. Do you want to go back with your family? (yes/no):").lower()
